...
export default function HomeClient({ initialData }: HomeClientProps) {
  ...
  const [activities] = useState<any[]>(initialData.activities);
  const [reviews] = useState<any[]>(initialData.reviews);
    ...
    <>
        ...
        <style jsx global>{`
          @media (max-width: 768px) {
            .cards-grid .card {
              ...
              min-height: calc(55vw + 160px) !important;
              display: flex !important;
      ...
      <section className="cta">
        ...
        <div className="cta-buttons">
          <a href="https://wa.me/420734332131" className="cta-btn" onClick={() => trackClick('whatsapp')}>
          ...
          <a href="https://t.me/lovelygirls_prague" className="cta-btn" onClick={() => trackClick('telegram')}>
          ...
          <a href="tel:+420734332131" className="cta-btn" onClick={() => trackClick('call')}>
