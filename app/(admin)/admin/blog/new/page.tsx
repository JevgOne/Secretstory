...
export default function NewBlogPostPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (data.success) {
        ...
        setError(data.error || 'Chyba při vytváření článku');
      }
    } catch (err) {
  ...
  return (
    <>
      <AdminHeader title="Nový článek" showBack={false} />
      <div className="admin-container">
        <div className="admin-header">
          <div>
            <h1 className="admin-title">Vytvořit nový článek</h1>
            <p className="admin-subtitle">Napište nový blogový příspěvek</p>
          </div>
