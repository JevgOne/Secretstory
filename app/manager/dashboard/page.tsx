  ...
  return (
    <>
      ...
      <header className="app-header">
        <div>
          <div className="app-header-title">Manager Panel</div>
          <div className="app-header-subtitle">Pátek, 29. listopadu</div>
        </div>
        <div className="app-header-right">
          <button className="app-header-btn">
            ...
            <span className="app-notification-badge">{pendingBookings.length}</span>
          </button>
      ...
      <nav className="app-bottom-nav">
        <Link href="/manager/dashboard" className="app-nav-item active">
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
        ...
        <Link href="/manager/girls" className="app-nav-item">
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
        ...
        <Link href="/manager/calendar" className="app-nav-item">
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
