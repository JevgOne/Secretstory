...
export default function Home() {
  ...
  const [newGirls, setNewGirls] = useState<Girl[]>([]);
  ...
  return (
    <>
      ...
      {/* NEW GIRLS SECTION */}
      {newGirls.length > 0 && (
        <section className="new-girls-section" style={{ background: 'rgba(139, 41, 66, 0.03)', padding: '4rem 0' }}>
          <div className="container" style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 4%' }}>
            <div style={{ textAlign: 'center', marginBottom: '3rem' }}>
              ...
              <p className="section-subtitle">Nejnovější přírůstky do naší kolekce</p>
            </div>
            <div className="cards-grid" style={{ gridTemplateColumns: 'repeat(auto-fill, minmax(280px, 1fr))' }}>
              {newGirls.map((girl) => {
                const badge = girl.badge_type || 'new';
